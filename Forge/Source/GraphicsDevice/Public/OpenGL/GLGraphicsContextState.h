...
namespace Forge {
	namespace Graphics
	{
		...
		public:
			 ...
			 * @throws InvalidOperationException if the TWeakPtr is expired.
			 */
			Void DeleteHardwareBuffer(TWeakPtr<AbstractHardwareBuffer> hardware_buffer) override;
			 ...
			 * @throws InvalidOperationException if the TWeakPtr is expired.
			 */
			Void DeleteVertexDecleration(TWeakPtr<AbstractVertexDecleration> vertex_decleration) override;
		};
